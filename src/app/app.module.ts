...
import {
	SukuButtonsModule, SukuWebcomponentsService, SukuFormFooterModule, SukuWebcomponentsModule
...
@NgModule({
	...
	imports: [BrowserModule, AppRoutingModule, BrowserAnimationsModule,
		FormsModule, ReactiveFormsModule, SukuButtonsModule, SukuFormFooterModule, SukuWebcomponentsModule
	],
